...
## Project Structure
    ...
    ├── testapiautosetting_124852  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124852`
...
2. Clone this repo and `cd testapiautosetting_124852`
